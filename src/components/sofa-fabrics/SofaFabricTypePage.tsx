...
import { ChevronRight, ArrowLeft, ArrowRight, ArrowUpDown, Heart, Layers } from 'lucide-react';
      ...
      <div className="border-b border-[#EAE4D8] bg-[#F7F4EE]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            {/* Breadcrumb: Home → Sofa Fabrics & Upholstery → Fabric Type */}
            ...
            {/* Back to Sofa Fabrics & View All Link */}
          ...
          {sortedProducts.length > 0 ? (
            ...
            <div className="py-16 text-center bg-white rounded-2xl border border-[#EAE4D8] p-8 max-w-md mx-auto">
              <p className="font-serif text-[18px] text-[#1C1917] mb-2">
                No products available yet in {sofaFabricType.name}.
              </p>
