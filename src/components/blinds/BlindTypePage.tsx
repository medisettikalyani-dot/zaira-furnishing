...
import { ChevronRight, ArrowLeft, ArrowRight, ArrowUpDown, Heart, SlidersHorizontal } from 'lucide-react';
...
export function BlindTypePage({ blindType, products }: BlindTypePageProps) {
      ...
      <div className="border-b border-[#EAE4D8] bg-[#F7F4EE]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            {/* Breadcrumb: Home → Window Blinds & Shades → Blind Type */}
            <nav className="flex items-center gap-1.5 text-[12px] text-[#78716C] flex-wrap">
              ...
              <ChevronRight className="w-3.5 h-3.5 text-[#A8A29E]" />
              <span className="text-[#1C1917] font-medium">{blindType.name}</span>
            </nav>

            {/* Back to Blinds & View All Link */}
            <div className="flex items-center gap-4 text-[12px]">
              ...
              >
                ...
                <span>Back to Window Blinds</span>
              </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4 pb-4 border-b border-[#EAE4D8]">
            ...
            <div className="flex items-center gap-2 self-start sm:self-auto">
              <label htmlFor="blind-sort" className="text-[11.5px] uppercase tracking-wider text-[#78716C] font-medium flex items-center gap-1">
          ...
          {sortedProducts.length > 0 ? (
            ...
            <div className="py-16 text-center bg-white rounded-2xl border border-[#EAE4D8] p-8 max-w-md mx-auto">
              <p className="font-serif text-[18px] text-[#1C1917] mb-2">
                No products available yet in {blindType.name}.
              </p>
